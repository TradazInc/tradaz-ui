...
const BASE_INVENTORY: MockDetailedProduct[] = [
  {
    ...
    brand: "Tradaz Basics",
    description:
      "A highly comfortable, 100% cotton t-shirt perfect for everyday wear. Breathable and stylish.",
    specs: {
      brand: "Tradaz Basics",
      type: "Physical",
      gender: "Unisex",
  ...
  },
  {
    ...
    brand: "Urban Kicks",
    description:
      "Sleek and durable streetwear sneakers designed for the modern hustle.",
    specs: {
      brand: "Urban Kicks",
      type: "Physical",
      gender: "Men",
  ...
  },
  {
    ...
    isFavorite: false,
    variations: 1,
    brand: "Lagos Streetwear",
    description:
      "Timeless denim jacket with deep pockets and a rugged aesthetic.",
    specs: {
      brand: "Lagos Streetwear",
      type: "Physical",
      gender: "Unisex",
...
export const useInventory = () => {
  // --- STATE ---
  const [inventory, setInventory] = useState<MockDetailedProduct[]>(() =>
    generateExtendedInventory(TOTAL_INVENTORY),
  );
  ...
  const detailedProduct =
    inventory.find((p) => p.id === selectedProductId) || null;
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        if (
          ...
          visibleCount < processedInventory.length &&
          !isLoadingMore
        ) {
          setIsLoadingMore(true);
          setTimeout(() => {
            setVisibleCount((prev) =>
              Math.min(prev + ITEMS_PER_PAGE, processedInventory.length),
            );
  ...
  return {
    ...
    sortBy,
    visibleItems,
    processedInventoryLength: processedInventory.length,
    visibleCount,
    isLoadingMore,
    loaderRef,
