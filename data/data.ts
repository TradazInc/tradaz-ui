...
export const generateDummyOnlineOrders = (
  ...
  return Array.from({ length: count }).map((_, i) => {
    const index = startIndex + i;
    const payStatus =
      index % 2 === 0 ? "Paid" : index % 5 === 0 ? "Refunded" : "Unpaid";
...
export const generateDummyRevenue = (
  ...
  const channels: RevenueTransaction["channel"][] = [
    "POS",
    "Online",
    "Online",
    "POS",
  ...
  return Array.from({ length: count }).map((_, i) => {
    ...
    return {
      ...
      amount: isRefunded
        ? -(15000 + ((index * 12000) % 80000))
        : 25000 + ((index * 34000) % 450000),
      date: `Feb ${20 - (index % 15)}, 2026`,
      status: isRefunded
        ? "Refunded"
        : index % 8 === 0
  ...
  return Array.from({ length: count })
    .map((_, i) => {
      ...
      return {
        ...
        date: pastDate.toLocaleDateString("en-GB", {
          day: "numeric",
          month: "short",
          year: "numeric",
        }),
        ...
        status: (daysAgo > 30 ? "Remitted" : "Pending") as
          | "Remitted"
          | "Pending",
      };
    })
...
export const generateDummyReviews = (count: number): ProductReview[] => {
  ...
  const categories: ProductReview["category"][] = [
    "Fashion",
    "Electronics",
    "Beauty",
    "Home",
    ...
    .map((_, i) => {
      ...
      return {
        ...
        status: (i % 4 === 0
          ...
          : i % 5 === 2
            ? "Disapproved"
            : "Approved") as "Pending" | "Approved" | "Disapproved",
      };
    })
...
export const generateDummyVouchers = (): GiftVoucher[] => {
  return [
    ...
    },
    {
      id: "VCH-102",
      code: "TRDZ-B2X1-P9Q7",
      recipientName: "Chuka Obi",
      recipientEmail: "chuka@example.com",
      initialValue: 100000,
      remainingBalance: 0,
    ...
    },
    {
      id: "VCH-104",
      code: "TRDZ-J7N8-W4R1",
      recipientName: "Emmanuel K.",
      recipientEmail: "emmanuel@example.com",
      initialValue: 15000,
    ...
    },
    {
      id: "VCH-105",
      code: "TRDZ-T9H2-F6D5",
      recipientName: "Tolu F.",
      recipientEmail: "tolu@example.com",
      initialValue: 75000,
...
export const generateDummyPromotions = (): PromotionCampaign[] => {
  return [
    ...
    {
      id: "PRM-002",
      title: "Sneakerhead Week",
      type: "Category Discount",
      target: "Men's Sneakers",
    ...
    {
      id: "PRM-004",
      title: "Clearance BOGO",
      type: "Buy X Get Y",
      target: "Winter Collection",
      discountValue: "50% Off 2nd Item",
...
export const generateDummyPopups = (): PopupCampaign[] => {
  return [
    ...
    {
      id: "POP-002",
      name: "Wait! Don't Leave Empty Handed",
      type: "Exit Intent",
    ...
    {
      id: "POP-003",
      name: "Free Delivery This Weekend",
      type: "Announcement",
      trigger: "Immediately",
      views: 45000,
      conversions: 3200,
  ...
  return [
    {
      ...
      message: "Free Delivery on all orders over ₦50,000 this weekend!",
      ctaText: "Shop Now",
    ...
    {
      id: "BNR-002",
      name: "Easter Mega Sale",
      message: "Up to 40% OFF across all categories.",
      ctaText: "View Deals",
      ctaLink: "/sale/easter",
    ...
    },
    {
      ...
      message: "Get 10% off your first order when you shop on our mobile app.",
      ctaText: "Download",
      ctaLink: "/app",
    ...
    {
      id: "BNR-004",
      name: "Cart Abandonment Warning",
      message:
        "Stock is running out! Complete your checkout to secure your items.",
      ctaText: "Checkout",
      ctaLink: "/checkout",
  ...
  return [
    {
      ...
      description: "Reward customers for signing up.",
      pointsAwarded: 500,
      status: "Active",
    },
    {
      ...
      description: "Reward points for verified purchase reviews.",
      pointsAwarded: 200,
      status: "Active",
    },
    {
      ...
      description: "Reward points when a referred friend makes a purchase.",
      pointsAwarded: 1000,
      status: "Disabled",
    },
    {
      ...
      description: "Reward points for subscribing to marketing emails.",
      pointsAwarded: 100,
      status: "Active",
    },
  ];
...
export const generateDummyVatRecords = (): VatRemittance[] => {
  return [
    ...
    },
    {
      ...
      remittedAmount: 310000,
      dueDate: "2026-02-21",
      status: "Remitted",
      firsReceiptNo: "FIRS-202601-A9X",
    },
    {
      id: "VAT-2512",
      period: "December 2025",
      collectedAmount: 520000,
      remittedAmount: 520000,
      dueDate: "2026-01-21",
      status: "Remitted",
      firsReceiptNo: "FIRS-202512-B2M",
    },
    {
      id: "VAT-2511",
      period: "November 2025",
      collectedAmount: 195000,
      remittedAmount: 195000,
      dueDate: "2025-12-21",
      status: "Remitted",
      firsReceiptNo: "FIRS-202511-C7K",
    },
  ];
};
      ...
      messages: [
        {
          id: "M1",
          sender: "user",
          text: "Hello! I ordered the vintage denim jacket yesterday. Can I change the size from M to L before it ships?",
          timestamp: "10:42 AM",
        },
      ],
    },
      ...
      messages: [
        {
          id: "M1",
          sender: "user",
          text: "My tracking number says delivered, but I haven't received anything.",
          timestamp: "Yesterday, 4:15 PM",
        },
        {
          id: "M2",
          sender: "admin",
          text: "Hi Chuka, I'm so sorry about that. Let me check with GIG Logistics immediately.",
          timestamp: "Yesterday, 4:20 PM",
        },
        {
          id: "M3",
          sender: "user",
          text: "Please do. I really need those items by Friday.",
      ...
      messages: [
        {
          id: "M1",
          sender: "user",
          text: "Do you guys do wholesale discounts? I want to buy 50 pieces for my boutique.",
          timestamp: "Mon, 9:00 AM",
        },
        {
          id: "M2",
          sender: "admin",
          text: "Hello Sarah! Yes we do. For 50 pieces, we can offer a 20% bulk discount. Would you like me to send a custom invoice?",
...
export const MOCK_MESSAGES: Message[] = [
  {
    id: "1",
    sender: "user",
    text: "Hello, I have an issue with order TRD-9823-XYZ.",
    timestamp: "10:30 AM",
  },
  {
    id: "2",
    sender: "admin",
    text: "Hi Wada! I'm here to help. What seems to be the problem?",
    timestamp: "10:32 AM",
  },
  {
    id: "3",
    sender: "user",
    text: "The size I received is L, but I ordered XL.",
    timestamp: "10:35 AM",
  },
];
...
export const MOCK_PAST_REVIEWS: PastReview[] = [
  {
    ...
    rating: 5,
    comment:
      "Absolutely love these! Fits perfectly and the delivery was incredibly fast.",
    date: "Feb 20, 2026",
  },
];
