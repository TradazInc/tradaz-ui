              ...
              <VStack align="stretch" gap={1} pb={4}>
                {SUPER_ADMIN_NAV_ITEMS.map((item) => {
                  const isParentActive =
                    pathname.startsWith(
                      item.path || "some-unmatchable-string",
                    ) ||
                        ...
                        >
                          <Flex align="center" gap={3}>
                            <Icon
                              as={item.icon}
                              fontSize="lg"
                              color={isParentActive ? brandColor : "inherit"}
                              strokeWidth="2.5"
                            />
                            {!isCollapsed && (
                              <Text
                                fontSize="sm"
                                fontWeight={isParentActive ? "bold" : "medium"}
                                whiteSpace="nowrap"
                                letterSpacing="tight"
                              >
                                {item.label}
                              ...
                              return (
                                ...
                                >
                                  <Flex
                                    ...
                                    transition="all 0.2s"
                                    bg={
                                      isChildActive ? "#111111" : "transparent"
                                    }
                                    color={isChildActive ? "white" : "#888888"}
                                    border="1px solid"
                                    borderColor={
                                      isChildActive ? "#333333" : "transparent"
                                    }
                                  ...
                                  >
                                    <Flex align="center" gap={2.5}>
                                      <Icon
                                        ...
                                        fontSize="md"
                                        color={
                                          isChildActive ? brandColor : "inherit"
                                        }
                                        strokeWidth="2.5"
                                      />
                                      <Text
