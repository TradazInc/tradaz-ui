...
const REFUND_KPIs = [
  ...
  {
    label: "Dispute Reversals",
    value: "28",
    trend: "Admin Enforced",
    icon: LuUndo,
    iconColor: "blue.400",
  },
  {
...
const INITIAL_REFUNDS: RefundRecord[] = [
  {
    ...
    amount: 45000,
    reason: "Item profoundly damaged",
    status: "Pending",
    date: "Today, 09:12 AM",
  },
  {
  ...
  },
  {
    ...
    shopName: "Minimalist Hub",
    amount: 15000,
    reason: "Wrong item color received",
    status: "Rejected",
  ...
  },
  {
    id: "RFD-9094",
    orderId: "ORD-1237",
    customerName: "Wada Gift",
    shopName: "Glow Beauty Cosmetics",
    amount: 85000,
    reason: "Suspected payment fraud",
    status: "Requires Action",
    date: "Oct 20, 16:45 PM",
  },
  {
    id: "RFD-9095",
    orderId: "ORD-1238",
    customerName: "Aisha Bello",
    shopName: "Lagos Streetwear",
    amount: 25000,
    reason: "Size mismatch",
    status: "Processed",
    date: "Oct 18, 08:20 AM",
  },
  {
    id: "RFD-9096",
    orderId: "ORD-1239",
    customerName: "John Doe",
    shopName: "Mama's Kitchen Spices",
    amount: 8500,
    reason: "Expired items delivered",
    status: "Processed",
    date: "Oct 15, 12:10 PM",
  },
];
...
const RefundDetailsDrawer = ({
  ...
  onClose: () => void;
  onUpdateStatus: (id: string, status: RefundRecord["status"]) => void;
}) => {
              ...
              >
                ...
                >
                  <VStack w="full" gap={6} align="stretch">
                    ...
                    {/* Reason */}
                    <Box bg="#111111" p={5} border="1px solid #1A1A1A">
                      <Text color="#888888" fontSize="sm" mb={1}>
                      ...
                      <Text
                        ...
                        textAlign="right"
                      >
                        Requested: {refund.date}
                      </Text>
                    </Box>

                    {/* Admin Note Box (If actionable) */}
                    {(refund.status === "Pending" ||
                      refund.status === "Requires Action") && (
                      <Box>
                        <Text
                          color="#888888"
                          fontSize="10px"
...
export default function RefundsPage() {
  ...
  const [inlineProcessingId, setInlineProcessingId] = useState<string | null>(
    null,
  );
    ...
    >
      ...
      >
        <Box>
          ...
          <Text color="#888888" fontSize="sm">
            Manage customer chargebacks, order cancellations, and merchant
            debits.
          </Text>
        </Box>
        ...
        <Button
          ...
          fontWeight="bold"
        >
          <Icon as={LuDownload} color="#888888" strokeWidth="2.5" /> Export
          Ledger
        </Button>
      </Flex>
        ...
        >
          ...
          >
            ...
            <select style={nativeSelectStyle}>
              <option value="30d" style={{ background: "#000000" }}>
                Last 30 Days
              </option>
              <option value="7d" style={{ background: "#000000" }}>
                Last 7 Days
              </option>
            </select>
            <select
            ...
            >
              ...
              <option value="Pending" style={{ background: "#000000" }}>
                Pending Approval
              </option>
              <option value="Requires Action" style={{ background: "#000000" }}>
                Requires Action
              </option>
              <option value="Processed" style={{ background: "#000000" }}>
                Processed
              </option>
              <option value="Rejected" style={{ background: "#000000" }}>
                Rejected
              </option>
            </select>
          </Flex>
        ...
        <ScrollArea.Root maxW="full">
          <ScrollArea.Viewport pb={4}>
            <Box minW="1100px">
              {/* Columns Header */}
              <Grid
                templateColumns="1.2fr 1.5fr 1.5fr 1fr 1.2fr 100px"
                gap={4}
                px={6}
                py={4}
                bg="#111111"
                    ...
                    return (
                      ...
                      >
                        ...
                        <Flex justify="flex-end" gap={2} pt={1}>
                          ...
                          refund.status === "Requires Action" ? (
                            <IconButton
                              onClick={(e) => handleInlineApprove(e, refund.id)}
                              disabled={isProcessingInline}
