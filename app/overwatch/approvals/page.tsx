...
const INITIAL_APPLICATIONS: PendingBusiness[] = [
  {
    id: "REQ-1042",
    businessName: "Lagos Streetwear Co.",
    ownerName: "Chuka Obi",
    email: "chuka@lagosstreetwear.ng",
  ...
  {
    id: "REQ-1043",
    businessName: "Tech Haven Hub",
    ownerName: "Sarah Connor",
    email: "sarah.c@techhaven.io",
  ...
  {
    id: "REQ-1044",
    businessName: "Mama's Kitchen Spices",
    ownerName: "Grace Okafor",
    email: "grace@mamasspices.com",
    businessType: "Groceries",
    appliedAt: "1 day ago",
    kycStatus: "Missing Docs",
  },
  {
    id: "REQ-1045",
    businessName: "Urban Kicks NG",
    ownerName: "Wada Gift",
    email: "hello@urbankicks.ng",
  ...
  {
    id: "REQ-1046",
    businessName: "Glow Beauty Cosmetics",
    ownerName: "Aisha Bello",
    email: "aisha@glowbeauty.com",
...
const getKycBadgeStyle = (status: string) => {
  switch (status) {
    ...
    default:
      return { bg: "#111111", color: "#888888", border: "1px solid #333333" };
  }
};
                  ...
                  <VStack w="full" gap={6} align="stretch">
                    ...
                    >
                      ...
                      >
                        <Icon
                          as={
                            app.kycStatus === "Verified" ? LuCheck : LuFileText
                          }
                          boxSize="12px"
                          strokeWidth="3"
                        />
...
export default function PendingApprovalsPage() {
  ...
  const [applications, setApplications] =
    useState<PendingBusiness[]>(INITIAL_APPLICATIONS);
    ...
    >
      ...
      >
        <Box>
          ...
          <Text color="#888888" fontSize="sm">
            Review and approve new business applications to join the Tradaz
            platform.
          </Text>
        </Box>
        ...
        <Flex direction={{ base: "column", md: "row" }} gap={4} w="full">
          ...
          >
            ...
            <select style={nativeSelectStyle} defaultValue="All">
              ...
              <option value="Fashion" style={{ background: "#000000" }}>
                Fashion & Apparel
              </option>
              <option value="Electronics" style={{ background: "#000000" }}>
                Electronics
              </option>
              <option value="Groceries" style={{ background: "#000000" }}>
                Groceries
              </option>
            </select>
            <select
            ...
            >
              ...
              <option value="Verified" style={{ background: "#000000" }}>
                KYC Verified
              </option>
              <option value="Pending Review" style={{ background: "#000000" }}>
                KYC Pending
              </option>
              <option value="Missing Docs" style={{ background: "#000000" }}>
                Missing Docs
              </option>
            </select>
          </Flex>
      ...
      >
        <Box minW="1000px">
          {/* Columns Header */}
          <Grid
            templateColumns="2.5fr 1.5fr 1.5fr 1fr 200px"
            gap={4}
            px={6}
            py={4}
            bg="#111111"
                  ...
                  >
                    ...
                    <Flex align="center" gap={4}>
                      ...
                      <Box>
                        ...
                        <Text color="#888888" fontSize="xs" fontWeight="medium">
                    ...
                    <Flex justify="flex-end" gap={2}>
                      ...
                      <IconButton
                        ...
                        _hover={{ bg: "#E5E5E5" }}
                        disabled={
                          app.kycStatus !== "Verified" || processingId !== null
                        }
