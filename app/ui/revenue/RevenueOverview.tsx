...
export const RevenueOverview = () => {
  ...
  const getChannelStyle = (channel: string) => {
    ...
    switch (channel) {
      case "Online":
        return { ...baseStyle, icon: LuGlobe };
      case "POS":
        return { ...baseStyle, icon: LuStore };
      case "Subscription":
        return { ...baseStyle, icon: LuRepeat };
      default:
        return { ...baseStyle, icon: LuDollarSign };
    }
  };
      ...
      >
        <Box>
          <Text
            ...
            letterSpacing="tight"
          >
            <Icon as={LuTrendingUp} strokeWidth="2.5" /> Gross Revenue (
            {totalLimit})
          </Text>
          <Text color="gray.500" fontSize="sm">
            ...
            • Monitor incoming cash flow and sales channels.
          </Text>
        </Box>
        <Button
          variant="outline"
          ...
          <Flex gap={3} w={{ base: "full", md: "auto" }}>
            <Box flex={{ base: 1, md: "initial" }} w={{ md: "160px" }}>
              ...
              >
                ...
                <option value="online" style={{ background: "#111111" }}>
                  Online
                </option>
                <option value="pos" style={{ background: "#111111" }}>
                  POS
                </option>
                <option value="subscription" style={{ background: "#111111" }}>
                  Subscription
                </option>
              </select>
            </Box>
                    ...
                    <Box as="td" py={4} px={6}>
                      <Flex align="center" gap={2}>
                        <Flex
                          ...
                          justify="center"
                          bg={chanStyle.bg}
                          border={chanStyle.border}
                          color={chanStyle.color}
                          p={1.5}
                          rounded="none"
                        >
                          <Icon
