...
export const ReviewsManager = () => {
  ...
  const [categoryFilter, setCategoryFilter] = useState<
    "All" | "Fashion" | "Electronics" | "Beauty" | "Home"
  >("All");
      ...
      <HStack gap={1}>
        {[1, 2, 3, 4, 5].map((star) => (
          <Icon
            ...
            as={LuStar}
            boxSize="14px"
            color={star <= rating ? "orange.400" : "#333333"}
            fill={star <= rating ? "orange.400" : "transparent"}
          />
        ))}
      </HStack>
    );
          ...
          filteredAndSortedReviews.map((review) => {
            ...
            return (
              <Box
                ...
                rounded="none"
                border="1px solid"
                borderColor={isPending ? "rgba(237, 137, 54, 0.4)" : "#1A1A1A"}
                p={{ base: 4, md: 6 }}
                shadow="sm"
                transition="all 0.2s"
              >
                  ...
                  >
                    ...
                    {review.status !== "Disapproved" && (
                      <Button
                        ...
                        rounded="none"
                        onClick={() =>
                          updateReviewStatus(review.id, "Disapproved")
                        }
