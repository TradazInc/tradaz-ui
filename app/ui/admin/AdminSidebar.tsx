...
export const AdminSidebar = ({ isCollapsed, setIsCollapsed, setIsMobileOpen }: AdminSidebarProps) => {
    ...
    return (
        <Flex direction="column" h="full" w="full" bg="#000000">
            {/* --- HEADER LOGO --- */}
                ...
                {!isCollapsed && (
                    <Flex align="center" gap={3} overflow="hidden">
                        ...
                        <Text fontSize="xl" fontWeight="black" color="white" letterSpacing="tight" whiteSpace="nowrap">
                            TRADAZ HQ<Text as="span" color="#888888"> .</Text>
                        </Text>
                    </Flex>
                )}
                <IconButton 
                ...
                <Flex align="center" justify={isCollapsed ? "center" : "space-between"} gap={3}>
                    <Flex align="center" gap={3}>
                        <Avatar.Root size="sm" rounded="full">
                            <Avatar.Fallback name="Super Admin" bg="#111111" color="white" border="1px solid #333333" rounded="full" />
                        </Avatar.Root>
                        {!isCollapsed && (
                            <Box overflow="hidden">
                                <Text fontSize="sm" fontWeight="bold" color="white" whiteSpace="nowrap" letterSpacing="tight">Super Admin</Text>
                                <Text fontSize="10px" color="#888888" fontWeight="bold" textTransform="uppercase" letterSpacing="widest" whiteSpace="nowrap">Platform Owner</Text>
                            </Box>
                        )}
                    </Flex>
