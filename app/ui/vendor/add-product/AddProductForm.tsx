...
import { 
    ...
    LuTag, LuList, LuDollarSign, LuLayers, LuPlus, LuCheck, LuTrash2, LuClock
} from "react-icons/lu";
...
export const AddProductForm = () => {
    ...
    return (
        <Box w="full" pb={10} position="relative" bg="#000000">
                ...
                <Box bg="#0A0A0A" rounded="none" p={5} border="1px solid" borderColor={incompleteSteps === 0 ? "white" : "#1A1A1A"}>
                    ...
                    {incompleteSteps > 0 ? (
                        ...
                        <Flex mt={5} bg="#111111" border="1px solid" borderColor="white" rounded="none" p={4} align="center" gap={3}>
                            ...
                            <Text color="white" fontSize="sm" fontWeight="bold">All set! You can now submit your product for review.</Text>
                        </Flex>
                    )}
                </Box>
            </Box>
            ...
            <Box pt={6} borderTop="1px solid #1A1A1A">
                
               
                <Flex bg="#111111" border="1px solid #333333" p={4} mb={6} align="flex-start" gap={3}>
                    <Icon as={LuClock} color="orange.400" boxSize="18px" mt={0.5} strokeWidth="2.5" />
                    <Box>
                        <Text color="white" fontSize="sm" fontWeight="bold">Merchant Approval Required</Text>
                        <Text color="gray.400" fontSize="xs" mt={1}>
                            Once you click &quot;Submit for Review&quot;, this product will be sent to the merchant for verification. Your product will only go live in the store after it has been approved.
                        </Text>
                    </Box>
                </Flex>

                <Flex justify="flex-end" align="center" gap={4}>
                    <Button variant="outline" rounded="none" borderColor="#333333" color="white" _hover={{ bg: "#111111" }} h="48px" px={8} bg="#0A0A0A">
                        Save Draft
                    </Button>
