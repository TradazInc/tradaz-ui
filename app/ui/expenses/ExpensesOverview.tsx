...
export const ExpensesOverview = () => {
  ...
  const getCategoryStyle = (category: string) => {
    ...
    switch (category) {
      case "Inventory":
        return { ...baseStyle, icon: LuBox };
      case "Marketing":
        return { ...baseStyle, icon: LuMegaphone };
      case "Operations":
        return { ...baseStyle, icon: LuSettings };
      case "Utilities":
        return { ...baseStyle, icon: LuZap };
      case "Payroll":
        return { ...baseStyle, icon: LuUsers };
      default:
        return { ...baseStyle, icon: LuChartPie };
    }
  };
      ...
      >
        <Box>
          <Text
            ...
            letterSpacing="tight"
          >
            <Icon as={LuTrendingDown} strokeWidth="2.5" /> Expenses (
            {totalLimit})
          </Text>
          <Text color="gray.500" fontSize="sm">
            ...
            • Track, categorize, and manage your business outflows.
          </Text>
        </Box>
        <Button
          bg="white"
          ...
          <Flex gap={3} w={{ base: "full", md: "auto" }}>
            <Box flex={{ base: 1, md: "initial" }} w={{ md: "160px" }}>
              ...
              >
                ...
                <option value="inventory" style={{ background: "#111111" }}>
                  Inventory
                </option>
                <option value="marketing" style={{ background: "#111111" }}>
                  Marketing
                </option>
                <option value="operations" style={{ background: "#111111" }}>
                  Operations
                </option>
                <option value="utilities" style={{ background: "#111111" }}>
                  Utilities
                </option>
                <option value="payroll" style={{ background: "#111111" }}>
                  Payroll
                </option>
              </select>
            </Box>
            <Box flex={{ base: 1, md: "initial" }} w={{ md: "160px" }}>
              <select
                ...
                style={nativeSelectStyle}
              >
                <option value="date" style={{ background: "#111111" }}>
                  Sort: Date
                </option>
                <option value="amount" style={{ background: "#111111" }}>
                  Sort: Amount
                </option>
              </select>
            </Box>
        ...
        <Box bg="#0A0A0A" rounded="lg" p={6} border="1px solid #1A1A1A">
          <Flex align="center" gap={3} mb={3}>
            <Flex
              ...
              p={2}
              rounded="md"
              border="1px solid rgba(92, 172, 125, 0.2)"
            >
              <Icon
                as={LuReceipt}
                color="#5cac7d"
          ...
          <Text
            ...
            letterSpacing="tight"
          >
            ₦{clearedExpenses.toLocaleString()}
          </Text>
        </Box>
                  ...
                  >
                    ...
                    <Box as="td" py={4} px={6}>
                      <Flex
                        ...
                        rounded="md"
                        bg={
                          expense.status === "Cleared" ? "white" : "transparent"
                        }
                        color={
                          expense.status === "Cleared" ? "black" : "gray.400"
                        }
                        border={
