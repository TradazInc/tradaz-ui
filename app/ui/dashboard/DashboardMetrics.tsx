...
const METRICS = [
    { label: "Total Revenue", value: "₦4,250,000", trend: "+12.5%", icon: LuDollarSign },
    { label: "Total Orders", value: "1,240", trend: "+8.2%", icon: LuPackage },
    { label: "Customers", value: "892", trend: "+5.1%", icon: LuUsers },
    { label: "Conversion Rate", value: "3.2%", trend: "+1.2%", icon: LuTrendingUp }
];
        ...
        >
            ...
            <Box position="relative" zIndex={1}>
                <Flex justify="space-between" align="center" mb={4}>
                    ...
                    {/* Icons  */}
                    <Icon as={metric.icon} boxSize={5} color="#888888" style={{ strokeWidth: "2.5" }} />
                </Flex>
