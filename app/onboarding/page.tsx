...
import { BusinessInfoForm } from '../components/ui/onboarding/business-info-form';
import { CategorySelection } from '../components/ui/onboarding/category-selection'; // Import new component
import { BrandingForm } from '../components/ui/onboarding/branding-form';
            ...
            <Container maxW="md">
                <VStack gap={6} w="full">
                    ...
                    <Box w="full" bg="white" p={8} borderRadius="2xl" shadow="lg" border="1px solid" borderColor="gray.100">
                        ...
                        {/* Progress Bar */}
                        <Box w="full" mb={8}>
                            <Progress.Root value={progressValue} size="xs" colorPalette="green">
                        ...
                        {/* Step Switcher */}
                        {step === 1 && (
                            <BusinessInfoForm data={formData} update={updateData} onNext={() => setStep(2)} />
                        )}
                        {step === 2 && (
                            <CategorySelection data={formData} update={updateData} onNext={() => setStep(3)} onBack={() => setStep(1)} />
                        )}
                        {step === 3 && (
                            <BrandingForm data={formData} update={updateData} onBack={() => setStep(2)} />
                        )}
