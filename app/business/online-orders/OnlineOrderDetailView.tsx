...
import { OnlineOrder } from "@/data/types";
...
export const OnlineOrderDetailView = ({
  order,
  onBack,
}: OnlineOrderDetailViewProps) => {
  const getStatusStyle = (status: string) => {
    switch (status) {
      case "Delivered":
        return { bg: "#111111", color: "white", border: "1px solid white" };
      case "Shipped":
        return { bg: "#111111", color: "#888888", border: "1px solid #888888" };
      case "Processing":
        return {
          bg: "transparent",
          color: "white",
      ...
      <SimpleGrid columns={{ base: 1, lg: 3 }} gap={8}>
            ...
            <Box p={6}>
              ...
              >
                ...
                <Text color="white" fontSize="sm" fontWeight="600">
                  ₦{(order.total * 0.7).toLocaleString()}
                </Text>
              </Flex>
              ...
              >
                ...
                <Text color="white" fontSize="sm" fontWeight="600">
                  ₦{(order.total * 0.3).toLocaleString()}
                </Text>
              </Flex>
        ...
        >
          ...
          >
            ...
            <Text color="#888888" fontSize="xs" fontWeight="500" mb={4}>
              Tracking:{" "}
              <Text
                as="span"
            ...
            >
              ...
              <Text color="#888888" fontSize="xs" fontWeight="500">
                123 Dummy Street, Phase 2, FCT Abuja, Nigeria
              </Text>
            </Flex>
          </Box>
          ...
          >
            ...
            <Flex justify="space-between" mb={2}>
              ...
              <Text
                color={order.paymentStatus === "Paid" ? "white" : "#888888"}
                fontSize="xs"
                fontWeight="bold"
                textTransform="uppercase"
                letterSpacing="wider"
