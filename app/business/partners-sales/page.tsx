...
const nativeSelectStyle: React.CSSProperties = { width: "100%", backgroundColor: "#0A0A0A", color: "white", height: "40px", borderRadius: "0px", padding: "0 12px", border: "1px solid #333333", outline: "none", cursor: "pointer", fontSize: "14px" };
        ...
        <Box p={{ base: 4, lg: 8 }} maxW="1400px" mx="auto" animation="fade-in 0.3s ease" position="relative" bg="#000000" minH="100vh">
            ...
            >
                <Flex direction={{ base: "column", md: "row" }} gap={3} w="full">
                    {/* Search Input */}
                    <Flex flex={1} align="center" {...controlStyles} w="full" _focusWithin={{ borderColor: "white" }}>
                        <Icon as={LuSearch} color="#888888" mr={2} strokeWidth="2.5" />
                        <Input 
                            placeholder="Search by brand name, coupon code, or partner..." 
                            border="none" color="white" h="full" px={0} w="full"
                    ...
                    <Flex gap={2} w={{ base: "full", md: "auto" }}>
                        <Box flex={1} w={{ md: "160px" }}>
                            <select value={sortByMetric} onChange={(e) => setSortByMetric(e.target.value)} style={nativeSelectStyle}>
                                <option value="revenue" style={{ background: "#000000" }}>Sort: Revenue</option>
                                <option value="commission" style={{ background: "#000000" }}>Sort: Commission</option>
                                <option value="orders" style={{ background: "#000000" }}>Sort: Orders</option>
                            </select>
                        </Box>
                        <Box flex={1} w={{ md: "160px" }}>
                            <select value={sortOrder} onChange={(e) => setSortOrder(e.target.value)} style={nativeSelectStyle}>
                                <option value="desc" style={{ background: "#000000" }}>Desc (High-Low)</option>
                                <option value="asc" style={{ background: "#000000" }}>Asc (Low-High)</option>
                            </select>
                        </Box>
                    </Flex>
                </Flex>
