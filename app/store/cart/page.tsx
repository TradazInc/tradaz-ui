      ...
      <SimpleGrid columns={{ base: 1, lg: 12 }} gap={8}>
                ...
                <Flex gap={4} direction={{ base: "column", sm: "row" }}>
                  ...
                  >
                    ...
                    <Flex justify="space-between" align="end">
                      <Text color={brandColor} fontWeight="black" fontSize="xl">
                      ...
                      >
                        <IconButton
                          ...
                          _hover={{ color: "white", bg: "whiteAlpha.100" }}
                          onClick={() =>
                            updateQuantity(item.id, item.variation, -1)
                          }
                        >
        ...
        <Box gridColumn={{ lg: "span 4" }}>
          <Box
            ...
            borderColor="whiteAlpha.100"
          >
            <Text color="white" fontSize="xl" fontWeight="black" mb={6}>
              Order Summary
            </Text>
            <VStack gap={4} align="stretch" mb={8}>
              ...
              <Flex justify="space-between" align="center">
                ...
                <Text color={brandColor} fontSize="2xl" fontWeight="black">
                  ₦{subtotal.toLocaleString()}
                </Text>
              </Flex>
